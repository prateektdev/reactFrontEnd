    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: {
                sFirst: "First",
                sLast: "Last",
                sNext: "Next <i class='fa fa-long-arrow-right'></i>",
                sPrevious: "<i class='fa fa-long-arrow-left'></i> Previous"
            },
            ...
            sSearch: "<span class='input-group-btn'><button class='btn' type='button'><i class='fa fa-search'></i></button></span>",
