...
class EditBook extends React.PureComponent {
    ...
    componentWillReceiveProps(props) { 
        ...
        if(props.getbook){
            if(props.getbook.book){
                this.setState({book:props.getbook.book}) ;
            }
        }
    }
    ...
    handleSubmit(e) {
        ...
        this.props.dispatch(bookActions.editBook(book)); 
        // this.props.dispatch(bookActions.editBook(this.state.book)); 

    }

    delete(){
        this.props.dispatch(bookActions.deleteBook(this.state.book.id)); 
    }
    cancel() {
                                ...
                                <div className="white_box">
                                    <form className="theme-form" onSubmit={this.handleSubmit}>
                                        ...
                                        <div className="form-submit">
                                            ...
                                            <button onClick={this.delete} className="btn-theme btn  btn-cancel">Delete</button>
                                            <button onClick={this.cancel} className="btn-theme btn">Cancel</button>
                                        </div>
                                    </form>
                                </div>
                            </section>
...
function mapStateToProps(state) {
    const { authentication, getusers, getbook } = state;
...
const connectedEditBook = connect(mapStateToProps)(EditBook);
export { connectedEditBook as EditBook };